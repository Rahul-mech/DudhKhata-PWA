      ...
      <div className="w-full max-w-sm rounded-2xl bg-[var(--card)] p-8 shadow-sm border border-[var(--border)]">
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-sm text-[var(--muted-foreground)]">
            Digital milk ledger based on fat
          </p>
        </div>
        ...
        <button
          onClick={handleLogin}
          disabled={loading}
          className="flex w-full items-center justify-center gap-3 rounded-xl bg-[var(--primary)] px-4 py-3 text-sm font-medium text-white transition hover:opacity-90 disabled:opacity-60"
        >
          {loading ? (
            "Signing in..."
          ) : (
        ...
        <p className="mt-6 text-center text-xs text-[var(--muted-foreground)]">
          Private ledger. Your data stays with you.
        </p>
      </div>
    </div>
  );
